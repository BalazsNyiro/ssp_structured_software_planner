...
def win_main(Prg, CanvasWidth=600, CanvasHeight=400):
    ...
    ################################################
    global CanvasWidget
    CanvasWidget = tkinter.Canvas(Root, width=CanvasWidth, height=CanvasHeight)
    ...
    CanvasWidget.grid(row=3, column=1, sticky="nsew") # tkinter.E

    Root.grid_columnconfigure(1, weight=1)
    Root.grid_rowconfigure(3, weight=1)

    ScrollVertical = tkinter.Scrollbar(Root, command=CanvasWidget.yview)
